...
#include <Fonts/FreeSans9pt7b.h>  //Police pour l'écran OLED
#include <Fonts/FreeSans18pt7b.h> //Police pour l'écran OLED
...
//Blinker
  blinker_1Hz = fBlinker(8, 9, 0.5, 0.5);
